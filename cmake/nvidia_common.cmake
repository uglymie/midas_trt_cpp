...
# gather TensorRT lib
# set(TensorRT_ROOT "D:/Program Files/TensorRT-8.2.0.6")
set(TensorRT_ROOT "D:/Program Files/TensorRT-8.6.1.6")
...
list(APPEND NVIDIA_ALL_LIBS ${TRT_NVINFER} ${TRT_NVINFER_PLUGIN} ${TRT_NVONNX_PARSER} )  #${TRT_NVCAFFE_PARSER}
...
message(STATUS "NVIDIA_ALL_LIBS: ${NVIDIA_ALL_LIBS}")
